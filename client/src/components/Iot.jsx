  ...
  return (
    ...
    <Container>
      <TextSection>
        ...
        <Features>
          <FeatureItem>Real-time Monitoring</FeatureItem>
          <FeatureItem>Data Analytics</FeatureItem>
          <FeatureItem>Automation Systems</FeatureItem>
        </Features>
      </TextSection>
      <ImageSection>
...
const ImageSection = styled.div`
  max-width: 40%;
  padding: 2em;
  background-color: #FBF9FF; /* 연한 배경색 */
  border-radius: 15px;
  background-image: linear-gradient(
    135deg,
    #FBF9FF, 
