...
export default function Sensor() {
  return (
    ...
    <Container>
      <TextSection>
        <Title>FEELINK</Title>
        <SubTitle>Anomaly Detection System</SubTitle>
        <Description>
            어제와 다른 오늘,  그리고 한걸음 한걸음 
            발전하고 성장하는 필링크코리아의 내일을 만들어 가겠습니다.
        </Description>
        <Features>
          <FeatureItem>OLED process data (vibration/load)</FeatureItem>
      ...
      <ImageSection>
        <Image src="/images/feelink/anomaly.jpg" alt="IoT Business" />
      </ImageSection>
    </Container>
    </>
  );
